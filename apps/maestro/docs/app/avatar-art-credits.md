...
is: _"original male pants by wulax, edited for **female** by Joe White."_ Composited side by side,
...
note reads _"edited for **female** base by Joe White"_ for its `thin` cut.
