...
- Instances are project-scoped and may appear in multiple workflows; the hook uses the active workflow from this session's own `maestro_sessions/<session_id>/session.json`. An unplaced instance is harmless.
